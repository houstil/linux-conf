...
(setq package-required-list '(ag auctex auto-compile auto-complete auto-install autopair clojure-mode color-theme-solarized color-theme cyberpunk-theme dtrt-indent ergoemacs-mode goto-chg highlight-parentheses key-chord multi-term multiple-cursors org-cua-dwim packed magit git-rebase-mode git-commit-mode paredit popup powerline psvn rainbow-delimiters smart-tab smex undo-tree yasnippet yasnippet-bundle zenburn-theme))
